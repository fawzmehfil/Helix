...
def _result_json(result) -> dict:
    return {
        ...
        "context_minimization": {
            ...
            "tokens_saved": result.tokens_saved_by_minimization,
            "optimization_overhead_tokens": result.optimization_overhead_tokens,
            "net_token_change": result.net_token_change,
        },
        "semantic_reuse": {
...
def _write_json_report(path: str, report, backend: str, model: str) -> None:
    payload = {
        ...
        "context_minimization": {
            ...
            "tokens_saved": report.optimized.tokens_saved_by_minimization,
            "optimization_overhead_tokens": report.optimized.optimization_overhead_tokens,
            "net_token_change": report.optimized.net_token_change,
        },
        "semantic_reuse": {
